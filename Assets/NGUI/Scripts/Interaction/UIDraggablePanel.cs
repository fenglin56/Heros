...
public class UIDraggablePanel : IgnoreTimeScale
{
	...
	public delegate void CalculateConstrainOffsetCallBack(Vector3 constraint);
	public CalculateConstrainOffsetCallBack ConstraintCallBack;//约束力回调，返回约束力
    ...
    /// <summary>
    /// hxz Locked set by outside
    /// </summary>
    public bool LockDraggable { get; set; }
	/// <summary>
