...
public class JianghuPlayerAssetManager
{
    ...
    public JianghuPlayerAssetManager()
    {
    }
    ...
    public static bool SplitAnimations(GameObject targetModel, out string errorInfo)
    {
        ...
        //Debug.Log(modelName + ":" + aniName.ToString());
    ...
    public static bool GenerateRoleBaseAsset(GameObject targetModel, out string errorInfo)
    {
        ...
        if (modelClone != null)
        {
            ...
            foreach (var smr in modelClone.GetComponentsInChildren<SkinnedMeshRenderer>(true))
            {
