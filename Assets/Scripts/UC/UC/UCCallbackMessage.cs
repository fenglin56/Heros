...
{
    public delegate void LoginSuccessDelegate(long playerID);
    public LoginSuccessDelegate OnLoginSuccess;
    public delegate void LoginFailedDelegate(string errorCode);
    public LoginFailedDelegate OnLoginFailed;

    public delegate void PaySuccessDelegate();
    public PaySuccessDelegate OnPaySuccess;
    public delegate void PayFailedDelegate(string errorCode);
    public PayFailedDelegate OnPayFailed;

    private static UCCallbackMessage m_instance;
    public static UCCallbackMessage Instance
    {
        get
        {
            if (m_instance != null)
